...
@if((Auth::user()->perfil == "admin") || (Auth::user()->perfil == "admingerente") || (Auth::user()->perfil == "adminfacturacion") || (Auth::user()->perfil == "adminprevencion") || (Auth::user()->perfil == "adminrrhh") || (Auth::user()->perfil == "adminmantencion"))

                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                     ...
                     @if((Auth::user()->perfil == "usuariomantencion") ||  (Auth::user()->perfil == "admin") || (Auth::user()->perfil == "adminmantencion"))   <li id="mantencionactive"><a href="{{URL::to('mantencionportal')}}">Mantencion</a></li> @endif
                        ...
                        @if((Auth::user()->perfil == "admin") || (Auth::user()->perfil == "adminprevencion") || (Auth::user()->perfil == "adminmantencion") || (Auth::user()->perfil == "admingerente") || (Auth::user()->perfil == "adminfacturacion") || (Auth::user()->perfil == "adminrhh"))
